...
const supportItems = [
  ...
  { title: "Help Center", url: "/admin/help-center", icon: HelpCircle },
];
...
export function AdminSidebar() {
  ...
  const NavItem = ({ item }: { item: typeof mainNavItems[0] & { badge?: number } }) => {
    // Inject badge if it's the notification item
